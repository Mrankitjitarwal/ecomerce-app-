...
final Uri _url = Uri.parse('https://www.instagram.com/mr.ankitjitarwal/');
                    ...
                    children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: TextButton(
                                        onPressed: () {
                                          _launchUrl(); // Call _launchURL function here
                                        },
                                        child: Text(
                                          "Follow",
                                          style: TextStyle(
                      ...
                      SizedBox(
                        ...
                        child: Row(
                          ...
                          children: [
                            friendAndMore("Post", "11"),
                            friendAndMore("FOLLOWER", "511"),
                            friendAndMore("FOLLOWING", "185"),
                          ],
                        ),
                      ),
                    ],
